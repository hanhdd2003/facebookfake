...
public class Manager {
    ...
    public void initUser() {
        con.addUser("Hung", "Bac Ninh", "8/7/2003", "hung", "123");
        con.addUser("Hanh", "Hai Phong", "3/3/2003", "hanh", "123");
        con.addUser("Thuy", "Vinh Phuc", "2/8/2003", "thuy", "123");
        con.addUser("Chung", "Tau", "1/11/2003", "chung", "123");
        con.addUser("Thang", "Lao Cai", "1/11/2003", "thang", "123");
    }
    ...
    public void signUp() {
        ...
        if (con.addUser(name, address, dob, username, password)) {
    ...
    public void addPostByUser(User user) {
        ...
        String postID = "PO" + this.postIdCounter;
        this.postIdCounter++;
    ...
    public void editCommnentInPost(User user, Post post) {
        if (post != null) {
            Comment oldComment = this.editComment(user, post);
    ...
    public void deleteCommentInPost(User user, Post p) {
        Comment comment = this.editComment(user, p);
        if (p != null) {
